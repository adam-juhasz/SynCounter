...
MAKEFILE = meanImgFiltLSM_mex.mk

include meanImgFiltLSM_mex.mki


SRC_FILES =  \
	meanImgFiltLSM_data.cu \
	meanImgFiltLSM_initialize.cu \
	meanImgFiltLSM_terminate.cu \
	meanImgFiltLSM.cu \
	_coder_meanImgFiltLSM_info.cu \
	_coder_meanImgFiltLSM_api.cu \
	_coder_meanImgFiltLSM_mex.cu \
	MWCudaDimUtility.cu \
	cpp_mexapi_version.cpp

MEX_FILE_NAME_WO_EXT = meanImgFiltLSM_mex
...
SYS_INCLUDE += -I "D:\Adam\codes\codegen\mex\meanImgFiltLSM"
...
%.$(OBJEXT) : D:\Adam\codes/%.cu
	$(NVCC) $(NVCCFLAGS) "$<"
%.$(OBJEXT) : D:\Adam\codes\codegen\mex\meanImgFiltLSM/%.cu
	$(NVCC) $(NVCCFLAGS) "$<"
%.$(OBJEXT) : interface/%.cu
	$(NVCC) $(NVCCFLAGS) "$<"
...
%.$(OBJEXT) : D:\Adam\codes/%.c
	$(NVCC) $(NVCCFLAGS) "$<"
%.$(OBJEXT) : D:\Adam\codes\codegen\mex\meanImgFiltLSM/%.c
	$(NVCC) $(NVCCFLAGS) "$<"
%.$(OBJEXT) : interface/%.c
	$(NVCC) $(NVCCFLAGS) "$<"
...
%.$(OBJEXT) : D:\Adam\codes/%.cpp
	$(CC) $(CPPFLAGS) "$<"
%.$(OBJEXT) : D:\Adam\codes\codegen\mex\meanImgFiltLSM/%.cpp
	$(CC) $(CPPFLAGS) "$<"
